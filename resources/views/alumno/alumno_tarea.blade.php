        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="{{url('alumno_inicio')}}">Inicio <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('alumno_tarea')}}">Tarea</a>                    
                </li>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="th_deg" scope="col">Tema</th>
                        <th class="th_deg" scope="col">Fecha de entrega</th>
                        <th class="th_deg" scope="col">Archivo</th>
                    </tr>
                </thead>
                <tbody>   
                    @foreach ($tarea as $tareas)
                    <tr>
                         <td>{{ $tareas->materia   }}</td>
                         <td>{{ $tareas->Tema }}</td> 
