...
@section('content_header')
    ...
    <p class="font_size">Crear Padre de familia</p>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="div_center">
                <form action="{{url('/crear_padreFamilia')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="div_design">
                        <input type="submit" value="Registrar Padre de familia" class="btn btn-primary">                        
                    </div>
                </form>
            </div> 
        </div>
