...
@section('content_header')
    ...
    <p class="font_size">Actualizar Curso</p>
    <div style="text-align: center;">
        <div style="color: white; display: inline-block;">
            <a class="btn btn-info" href="{{url('mostrar_curso')}}">
                Regresar</a>
        </div>
    </div>
@stop
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="div_center">
                <form action="{{url('/confirmar_curso', $curso->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    
                    <div class="div_design">
                        <label class="text-align:center;">Grado</label>
                        <input class="text_color" type="text" name="Grado" 
