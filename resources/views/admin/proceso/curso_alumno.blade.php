        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="div_center">
                    ...
                    <form action="{{ url('/crear_curso_alumno') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="th_deg" scope="col">Nombre del alumno</th>                             
            ...
            @foreach ($cursoAlumno as $cursoEstudiante)
                <tr>
                    <td>{{$cursoEstudiante->curso->Grado}}</td>
                    <td>{{$cursoEstudiante->alumno->Nombre}}
                        {{$cursoEstudiante->alumno->ApellidoMaterno}}
                </td>
                    <td>{{$cursoEstudiante->profesor->Nombre}}
                        {{$cursoEstudiante->profesor->ApellidoPaterno}}
                    </td>
                    <td>
