...
@section('content_header')
    ...
    <p class="font_size">Crear Usuario Profesor</p>
                ...
                <form action="{{url('/crear_nuevo_usuario')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="div_design">
                        ...
                        <select class="text_color" name="name" required="">
                            ...
                            @foreach ($profe as $prof)
                                <option value="{{ $prof->Nombre}} {{ $prof->ApellidoPaterno }}">{{ $prof->Nombre}}
                                    ... {{ $prof->ApellidoPaterno }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="div_design">
                    ...
                    <div class="div_design">
                        ...
                        <select class="text_color" name="email" required="">
                            <option value="" selected>Seleccionar usuario...</option>
                            @foreach ($profe as $prof)
                                <option value="{{ $prof->Correo }}">{{ $prof->Correo}}
                                    ... </option>
                            @endforeach
                        </select>
                    </div>
